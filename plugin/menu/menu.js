	...
	loadResource(options.path + '/font-awesome-4.3.0/css/font-awesome.min.css', 'stylesheet', function() {
		...
		if (!bowser.msie || bowser.version >= 9) {
			...
			if (typeof themes === "undefined") {
				themes = [
					{ name: 'Default', theme: 'css/theme/night-qbane.css' },
			...
			if (transitions) {
				$('<li data-panel="Transitions" data-button="' + (buttons++) + '" class="toolbar-panel-button"><span class="slide-menu-toolbar-label">Trans</span><br/><i class="fa fa-arrows-h"></i></li>')
					.appendTo(toolbar)
					.click(openPanel);
			}
